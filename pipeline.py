...
from sklearn.model_selection import train_test_split #splits data into training and testing set
from sklearn.pipeline import Pipeline
from sklearn.compose import ColumnTransformer #allow link different pipelines, catagorical and miracle data
from sklearn.preprocessing import StandardScaler, OneHotEncoder #encording catagorical data
from sklearn.impute import SimpleImputer#handle missing data
from sklearn.ensemble import RandomForestRegressor#regressive task, decision tree
from sklearn.metrics import mean_squared_error, r2_score, mean_absolute_error#testing and evaluate model
import numpy as np
import joblib

# Load the dataset from a CSV file
data = pd.read_csv('vehicle_emissions.csv') #load in our data
print(data.head())#

# Separate features (X) and target variable (y)
X = data.drop(['CO2_Emissions'], axis=1)#x is front of our "flashcard" and we drop the C02 emissions so model does not see the answers
y = data['CO2_Emissions']#y is our answers named to a variable
